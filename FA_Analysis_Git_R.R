# TODO: Add comment Author: Brad File: FA_Analysis.R Version: 1.0 Date: 07.10.2013 Purpose: Analyze Fund Advertising
...
if (Location == 1) {
  #setwd("")
  input_directory <- normalizePath("C:/Users/Brad/Dropbox/Research/Fund_Advertising/R/", winslash = "\\", mustWork = NA)
  output_directory <- normalizePath("C:/Users/Brad/Dropbox/Research/Fund_Advertising/R/", winslash = "\\", mustWork = NA)
